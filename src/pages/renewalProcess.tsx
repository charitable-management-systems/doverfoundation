  ...
  return (
    <BreakpointProvider value={'large'}>
      ...
      <Main>
        ...
        <Section>
          <ul>
            <li>Current awardees who are eligible will automatically receive a renewal form each May via email. You should not submit a new online application. Please inform us if your primary email address changes.</li>
            ...
            <li> College seniors continuing their undergraduate studies into a 5th year who have not previously received 4 years/$12,000 in scholarship support, may be eligible for one additional year support based on the circumstances and at the Program's sole discretion.</li>
            <li> This additional support will be limited to $1,500 per semester for a maximum of $3,000 and may not exceed scholarship support beyond a 5th year of undergraduate study.</li>
...
export const Head = () => (
  <Seo>
      <title>Dover Foundation - Renewal Process</title>
  </Seo>
)